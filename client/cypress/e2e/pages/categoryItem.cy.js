describe('Item Creation Page Category Dropdown', () => {
    it('shows updated categories after a category has been edited for items', () => {
      ...
      cy.contains('label', 'Category').next().children('select').should('contain', 'Book');
      cy.contains('label', 'Category').next().children('select').should('not.contain', 'Books');
  });
  ...
  it('does not show deleted categories when creating/editing items', () => {
    ...
    cy.contains('label', 'Category').next().children('select').should('not.contain', 'Tools');
  });
});
